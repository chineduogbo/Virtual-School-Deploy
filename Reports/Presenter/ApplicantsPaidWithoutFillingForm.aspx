<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicantsPaidWithoutFillingForm.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.ApplicantsPaidWithoutFillingForm" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="TypeOfreport" class="form-control" runat="server" Height="35px" Width="200px">
                            </asp:DropDownList>
