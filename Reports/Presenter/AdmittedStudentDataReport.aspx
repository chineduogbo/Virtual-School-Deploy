<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmittedStudentDataReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.AdmittedStudentDataReport" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="ddlProgramme">Programme</label>
                                        <asp:DropDownList ID="ddlProgramme" class="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProgramme_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="ddlDepartment">Department</label>
