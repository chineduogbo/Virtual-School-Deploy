<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FullPaymentDebtorsCount.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.FullPaymentDebtorsCount" %>
                                        ...
                                        <div class="form-inline col-md-offset-1">
                                            ...
                                            <div class="form-group">
                                                <asp:RadioButtonList ID="rblSortOption" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist2" AutoPostBack="True" >
                                                    ...
                                                    <asp:ListItem Value="1">&nbsp;No Payment Record</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
                                    </div>
