<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassAdmitList.aspx.cs" Async="true" Inherits="Abundance_Nk.Web.Reports.Presenter.ClassAdmitList" %>
...
<body>
    ...
    <form id="form1" runat="server">
                ...
                <ContentTemplate>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlLevel" class="form-control" runat="server" Height="35px" Width="200px">
                            </asp:DropDownList>
                            ...
                            <asp:Button ID="Button1" runat="server"  Text="Download Bulk Report" Width="111px" class="btn btn-success"   OnClick="Button1_Click"  />
                            <div class="form-group">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" ShowExportControls="true" ShowPrintButton="true" runat="server" Width="100%">
        </rsweb:ReportViewer>
    </form>
</body>
</html>