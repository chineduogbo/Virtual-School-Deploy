<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GstReportBulkAltEnt.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.GstReportBulkAltEnt" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlFaculty" class="form-control" runat="server" Height="35px" Width="200px">
                            </asp:DropDownList>
