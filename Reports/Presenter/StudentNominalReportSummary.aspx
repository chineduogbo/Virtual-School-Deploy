<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentNominalReportSummary.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.StudentNominalReportSummary" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnDisplayReport" CssClass="btn btn-success mr5" runat="server" Text="Display Undergraduate Report" OnClick="btnDisplayReport_Click" />
                                    </div>
                                     <div class="form-group">
