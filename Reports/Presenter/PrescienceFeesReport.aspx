<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrescienceFeesReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.PrescienceFeesReport" %>
                                ...
                                <div class="row col-md-12">
                                    <div class="col-md-offset-1">
                                        <div class="form-inline">
                                            ...
                                            <div class="form-group">
                                                <label class="sr-only" for="ddlFeeType"></label>
                                                <asp:DropDownList ID="ddlFeeType" CssClass="form-control" runat="server"></asp:DropDownList>
                                            </div>
