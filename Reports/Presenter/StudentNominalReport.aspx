<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentNominalReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.StudentNominalReport" %>
        ...
        <div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <p style="color:red">Select Session to download bulk</p>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnDisplayPGReport" CssClass="btn btn-success mr5" runat="server" Text="Display PG  Report" OnClick="btnDisplayPGReport_Click" />
                                    </div>
                                    <div class="form-group">
                                        
                                        <asp:Button ID="bulkDownload" CssClass="btn btn-success mr5" runat="server" Text="Undergraduate Bulk Download" OnClick="btnBulkReport_Click" />
                                        
                                    </div>
                                    <div class="form-group">
                                        
                                        <asp:Button ID="bulkPGDownload" CssClass="btn btn-success mr5" runat="server" Text="PG Bulk Download" OnClick="btnPGBulkReport_Click" />
                                        
                                    </div>
                                    <div class="form-group">
                                        
                                        <asp:Button ID="bulkIDEADownload" CssClass="btn btn-success mr5" runat="server" Text="IDEA Bulk Download" OnClick="btnIDEABulkReport_Click" />
