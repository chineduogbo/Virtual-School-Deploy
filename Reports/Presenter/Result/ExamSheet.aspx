<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamSheet.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.ExamSheet" %>
                            ...
                            <div class="panel-body">
                                <div class="form-inline">
                                    <div class="form-group">
                                        <label title="Sort Type">Type</label>
                                        &nbsp;
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:RadioButtonList ID="rblSortOption" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist2">
                                            ...
                                            <asp:ListItem Value="2">Plain/Blank</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                </div>
