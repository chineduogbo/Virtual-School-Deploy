<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transcript.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.Transcript" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="contentpanel">
                        <div class="panel panel-default">
                            ...
                            <div class="form-group">
                                <label class="sr-only" for="ddlSession"></label>
                                <asp:DropDownList ID="ddlSession" cssclass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged"></asp:DropDownList>
                            </div>
