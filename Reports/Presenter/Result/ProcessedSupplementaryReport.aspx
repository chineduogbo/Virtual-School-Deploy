<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessedSupplementaryReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.ProcessedSupplementaryReport" %>
...
<head runat="server">
    <title>Processed Supplementary Report</title>
        ...
        <div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="ddlInstitutionChoice"></label>
                                        <asp:DropDownList ID="ddlInstitutionChoice" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>

                                    <div class="form-group">
                                        <label class="sr-only" for="ddlFormType"></label>
                                        <asp:DropDownList ID="ddlFormType" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        &nbsp;&nbsp;
                                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-success mr5" OnClick="Button1_Click" Text="Download Bulk" />
                                    </div>
                                    <div class="form-group">
                    ...
                    <rsweb:ReportViewer ID="rv" runat="server" Height="800px" Width="100%"></rsweb:ReportViewer>
