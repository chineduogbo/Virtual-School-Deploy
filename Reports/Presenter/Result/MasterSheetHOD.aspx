<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MasterSheetHOD.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.MasterSheetHOD" %>
                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-group">
                                    <asp:RadioButtonList ID="rblSortOption" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist2">
                                        <asp:ListItem Value="1">Master Grade Sheet</asp:ListItem>
                                        <asp:ListItem Value="2">Master Score Sheet</asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                            </div>
