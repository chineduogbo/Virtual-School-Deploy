<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseEvaluationReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.CourseEvaluationReport" %>
                    ...
                    <div class="panel-body">
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlProgramme" cssclass="form-control" runat="server" ></asp:DropDownList>
                            </div>
