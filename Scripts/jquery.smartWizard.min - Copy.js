!(function (t, s, e, n) {
    ...
    t.extend(i.prototype, {
        ...
        _setElements: function () {
            ...
            return (
                ...
                t.each(this.options.disabledSteps, function (t, e) {
                    s.steps.eq(e).parent("li").addClass("disabledT");
                }),
        ...
        _setToolbar: function () {
            ...
            var s = this.options.toolbarSettings.showNextButton !== !1 ? t("<button></button>").text("Save And Continue").addClass("btn btn-primary sw-btn-next knownext").attr("type", "button") : null,
                ...
                n = t("<div></div>")
                    .addClass("btn-group navbar-btn sw-btn-group pull-" + this.options.toolbarSettings.toolbarButtonPosition)
                    .attr("role", "group")
                    .append(e, s),
                i = null;
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case "top":
                    ...
                    break;
                case "bottom":
                    (a = t("<nav></nav>").addClass("p-0 mt-5 btn-toolbar sw-toolbar sw-toolbar-bottom")), a.append(n), "right" === this.options.toolbarSettings.toolbarButtonPosition ? a.append(i) : a.prepend(i), this.container.after(a);
                    break;
                case "both":
                    (o = t("<nav></nav>").addClass("navbar btn-toolbar sw-toolbar sw-toolbar-top")),
                        o.append(n),
                        "left" === this.options.toolbarSettings.toolbarButtonPosition ? o.append(i) : o.prepend(i),
                        this.container.before(o),
                        (a = t("<nav></nav>").addClass("navbar btn-toolbar sw-toolbar sw-toolbar-bottom")),
                        a.append(n.clone(!0)),
                        "right" === this.options.toolbarSettings.toolbarButtonPosition ? a.append(i.clone(!0)) : a.prepend(i.clone(!0)),
                        this.container.after(a);
                    break;
                default:
                    (a = t("<nav></nav>").addClass("navbar btn-toolbar sw-toolbar sw-toolbar-bottom")), a.append(n), "right" === this.options.toolbarSettings.toolbarButtonPosition ? a.append(i) : a.prepend(i), this.container.after(a);
            }
            return !0;
        },
        _setEvents: function () {
        ...
        _showStep: function (t) {
            return !!this.steps.eq(t) && t != this.current_index && !this.steps.eq(t).parent("li").hasClass("disabled") &&
                !this.steps.eq(t).parent("li").hasClass("hidden") && (this._loadStepContent(t), !0);
        },
        _loadStepContent: function (s) {
            ...
            if ((null !== this.current_index && this.current_index !== s && (i = this.current_index < s ? "forward" : "backward"),
                null !== this.current_index && this._triggerEvent("leaveStep", [n, this.current_index, i]) === !1))
                return !1;
        ...
        _setAnchor: function (t) {
            return (
                ...
                (this.steps.eq(this.current_index).parent("li").addClass("done"), this.options.anchorSettings.removeDoneStepOnNavigateBack !== !1 &&
                    this.steps.eq(t).parent("li").nextAll().removeClass("done")),
                this.steps.eq(t).parent("li").removeClass("done danger loading").addClass("active"),
                !0
            );
        },
        _setButtons: function (s) {
            return (
                ...
                (0 >= s ? t(".sw-btn-prev", this.main).addClass("disabledT") : t(".sw-btn-prev", this.main).removeClass("disabledT"),
                    this.steps.length - 1 <= s ? t(".sw-btn-next", this.main).addClass("disabledT").removeClass("sw-btn-next").text("Submit") : t(".sw-btn-next", this.main).removeClass("disabledT").text("Save and Continue")),
                !0
            );
        },
        _keyNav: function (t) {
        ...
        theme: function (t) {
            ...
            this.main.removeClass("sw-theme-" + this.options.theme), (this.options.theme = t), this.main.addClass("sw-theme-" + this.options.theme),
        ...
        stepState: function (s, e) {
            ...
            if (i && i.length > 0)
                switch (e) {
                    case "disable":
                        t(i).parents("li").addClass("disabledT");
                        break;
                    case "enable":
                        t(i).parents("li").removeClass("disabledT");
                        break;
                    case "hide":
        ...
        (t.fn.smartWizard = function (s) {
            ...
            return void 0 === s || "object" == typeof s
                ...
                : "string" == typeof s && "_" !== s[0] && "init" !== s
                    ? ((e = t.data(this[0], "smartWizard")), "destroy" === s && t.data(this, "smartWizard", null),
                        e instanceof i && "function" == typeof e[s] ? e[s].apply(e, Array.prototype.slice.call(n, 1)) : this)
                    : void 0;
        });
