d3 = function() {
    ...
    function f() { mo.event.preventDefault(); }
    ...
    function p(n) { return Lo(n, Ro), n; }

    function d(n) { return"function" == typeof n ? n : function() { return Ho(n, this); }; }

    function v(n) { return"function" == typeof n ? n : function() { return Fo(n, this); }; }
    ...
    function y(n) { return n.trim().replace(/\s+/g, " "); }

    function M(n) { return new RegExp("(?:^|\\s+)" + mo.requote(n) + "(?:\\s+|$)", "g"); }

    function x(n, t) {
        function e() { for (var e = -1; ++e < u;)n[e](this, t); }

        function r() { for (var e = -1, r = t.apply(this, arguments); ++e < u;)n[e](this, r); }
    ...
    function S(n) { return"function" == typeof n ? n : (n = mo.ns.qualify(n)).local ? function() { return xo.createElementNS(n.space, n.local); } : function() { return xo.createElementNS(this.namespaceURI, n); }; }

    function E(n) { return{ __data__: n }; }

    function k(n) { return function() { return Oo(this, n); }; }

    function A(n) { return arguments.length || (n = mo.ascending), function(t, e) { return t && e ? n(t.__data__, e.__data__) : !t - !e; }; }
    ...
    function L() {
        ...
        return o[Vo] = "none", function(t) {
            function e() { i.on(u, null); }

            i.on(n, null), o[Vo] = a, t && (i.on(u, function() { f(), e(); }, !0), setTimeout(e, 0));
        };
    }
    ...
    function F(n) { return n > 0 ? 1 : 0 > n ? -1 : 0; }

    function P(n) { return n > 1 ? 0 : -1 > n ? Bo : Math.acos(n); }

    function O(n) { return n > 1 ? Jo : -1 > n ? -Jo : Math.asin(n); }

    function R(n) { return((n = Math.exp(n)) - 1 / n) / 2; }

    function Y(n) { return((n = Math.exp(n)) + 1 / n) / 2; }

    function I(n) { return((n = Math.exp(2 * n)) - 1) / (n + 1); }

    function U(n) { return(n = Math.sin(n / 2)) * n; }

    function Z() {}

    function V(n, t, e) { return new X(n, t, e); }

    function X(n, t, e) { this.h = n, this.s = t, this.l = e; }

    function $(n, t, e) {
        function r(n) { return n > 360 ? n -= 360 : 0 > n && (n += 360), 60 > n ? i + (o - i) * n / 60 : 180 > n ? o : 240 > n ? i + (o - i) * (240 - n) / 60 : i; }

        function u(n) { return Math.round(255 * r(n)); }
    ...
    function B(n, t, e) { return new W(n, t, e); }

    function W(n, t, e) { this.h = n, this.c = t, this.l = e; }

    function J(n, t, e) { return isNaN(n) && (n = 0), isNaN(t) && (t = 0), G(e, Math.cos(n *= Qo) * t, Math.sin(n) * t); }
    ...
    function nt(n, t, e) { return n > 0 ? B(Math.atan2(e, t) * na, Math.sqrt(t * t + e * e), n) : B(0 / 0, 0 / 0, n); }
    ...
    function ut(n) { return ot(n >> 16, 255 & n >> 8, 255 & n); }

    function it(n) { return ut(n) + ""; }

    function ot(n, t, e) { return new at(n, t, e); }

    function at(n, t, e) { this.r = n, this.g = t, this.b = e; }
    ...
    function dt(n) { return n; }

    function vt(n) { return function(t, e, r) { return 2 === arguments.length && "function" == typeof e && (r = e, e = null), mt(t, e, n, r); }; }
    ...
    function mt(n, t, e, r) {
        ...
        return!_o.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload" in c ? c.onload = c.onerror = u : c.onreadystatechange = function() { c.readyState > 3 && u(); }, c.onprogress = function(n) {
            var t = mo.event;
            mo.event = n;
            try {
                o.progress.call(i, c);
        ...
        }, i.header = function(n, t) { return n = (n + "").toLowerCase(), arguments.length < 2 ? a[n] : (null == t ? delete a[n] : a[n] = t + "", i); }, i.mimeType = function(n) { return arguments.length ? (t = null == n ? null : n + "", i) : t; }, i.responseType = function(n) { return arguments.length ? (l = n, i) : l; }, i.response = function(n) { return e = n, i; }, ["get", "post"].forEach(function(n) { i[n] = function() { return i.send.apply(i, [n].concat(Mo(arguments))); }; }), i.send = function(e, r, u) {
            ...
            return null != t && c.overrideMimeType && c.overrideMimeType(t), null != l && (c.responseType = l), null != u && i.on("error", u).on("load", function(n) { u(null, n); }), o.beforesend.call(i, c), c.send(null == r ? null : r), i;
        }, i.abort = function() { return c.abort(), i; }, mo.rebind(i, o, "on"), null == r ? i : i.get(yt(r));
    }
    ...
    function Nt(n, t) { n && Da.hasOwnProperty(n.type) && Da[n.type](n, t); }
    ...
    function zt() {
        ...
        var t, e, r, u, i;
        Ha.point = function(o, a) { Ha.point = n, r = (t = o) * Qo, u = Math.cos(a = (e = a) * Qo / 2 + Bo / 4), i = Math.sin(a); }, Ha.lineEnd = function() { n(t, e); };
    }
    ...
    function Pt(n) { return[Math.atan2(n[1], n[0]), O(n[2])]; }

    function Ot(n, t) { return Math.abs(n[0] - t[0]) < Go && Math.abs(n[1] - t[1]) < Go; }
    ...
    function Yt(n, t, e) { ++Fa, Oa += (n - Oa) / Fa, Ra += (t - Ra) / Fa, Ya += (e - Ya) / Fa; }
    ...
    function Zt() {
        ...
        }, Ba.lineEnd = function() { n(t, e), Ba.lineEnd = Ut, Ba.point = Rt; };
    }
            ...
            for (var s, f, h, g = i[0];;) {
                ...
                do {
                    if (s.visited = s.other.visited = !0, s.entry) {
                        if (s.subject)for (var a = 0; a < f.length; a++)u.point((h = f[a])[0], h[1]);
    ...
    function Bt(n, t, e, r) {
        return function(u, i) {
            ...
            function c() { y.point = a, v.lineStart(); }

            function l() { y.point = o, v.lineEnd(); }
            ...
            var g,
                ...
                y = {
                    ...
                    lineStart: c,
                    lineEnd: l,
                    polygonStart: function() { y.point = s, y.lineStart = f, y.lineEnd = h, g = [], p = [], i.polygonStart(); },
                    polygonEnd: function() {
    ...
    function Gt(n, t) { return((n = n.point)[0] < 0 ? n[1] - Jo - Go : Jo - n[1]) - ((t = t.point)[0] < 0 ? t[1] - Jo - Go : Jo - t[1]); }
    ...
    function ee(n) {
        ...
        function e(n) {
            ...
            return{
                ...
                lineEnd: function() { c && n.lineEnd(), e = null; },
                clean: function() { return s | (l && c) << 1; }
            };
        }
    ...
    function re(n, t, e, r) {
        function u(r, u) { return Math.abs(r[0] - n) < Go ? u > 0 ? 0 : 3 : Math.abs(r[0] - e) < Go ? u > 0 ? 2 : 1 : Math.abs(r[1] - t) < Go ? u > 0 ? 1 : 0 : u > 0 ? 3 : 2; }

        function i(n, t) { return o(n.point, t.point); }
        ...
        return function(c) {
            ...
            function h(u, i) { return u >= n && e >= u && i >= t && r >= i; }

            function g(n, t) { h(n, t) && c.point(n, t); }

            function p() { q.point = v, y && y.push(M = []), k = !0, E = !1, w = S = 0 / 0; }

            function d() { m && (v(x, b), _ && E && T.rejoin(), m.push(T.buffer())), q.point = g, E && c.lineEnd(); }
            ...
            var m,
                ...
                q = {
                    ...
                    lineStart: p,
                    lineEnd: d,
                    polygonStart: function() { c = T, m = [], y = [], A = !0; },
                    polygonEnd: function() {
                        c = N, m = mo.merge(m);
    ...
    function oe(n) {
        ...
        return u.parallels = function(n) { return arguments.length ? r(t = n[0] * Bo / 180, e = n[1] * Bo / 180) : [180 * (t / Bo), 180 * (e / Bo)]; }, u;
    }
    ...
    function ce() {
        function n(n, t) { Ka += u * n - r * t, r = n, u = t; }

        var t, e, r, u;
        rc.point = function(i, o) { rc.point = n, t = r = i, e = u = o; }, rc.lineEnd = function() { n(t, e); };
    }

    function le(n, t) { Qa > n && (Qa = n), n > tc && (tc = n), nc > t && (nc = t), t > ec && (ec = t); }
    ...
    function se() {
        ...
        var i = fe(4.5),
            ...
            a = {
                ...
                pointRadius: function(n) { return i = fe(n), a; },
                result: function() {
                    if (o.length) {
                        var n = o.join("");
                        return o = [], n;
    ...
    function fe(n) { return"m0," + n + "a" + n + "," + n + " 0 1,1 0," + -2 * n + "a" + n + "," + n + " 0 1,1 0," + 2 * n + "z"; }

    function he(n, t) { Oa += n, Ra += t, ++Ya; }
    ...
    function ge() {
        ...
        var t, e;
        ic.point = function(r, u) { ic.point = n, he(t = r, e = u); };
    }

    function pe() { ic.point = he; }
    ...
    function de() {
        ...
        var t, e, r, u;
        ic.point = function(i, o) { ic.point = n, he(t = r = i, e = u = o); }, ic.lineEnd = function() { n(t, e); };
    }

    function ve(n) {
        function t(t, e) { n.moveTo(t, e), n.arc(t, e, o, 0, Wo); }
        ...
        var o = 4.5, a = { point: t, lineStart: function() { a.point = e; }, lineEnd: u, polygonStart: function() { a.lineEnd = i; }, polygonEnd: function() { a.lineEnd = u, a.point = t; }, pointRadius: function(n) { return o = n, a; }, result: c };
        return a;
    }
    ...
    function me(n) {
        function t(t) {
            ...
            function u() { M = 0 / 0, S.point = o, t.lineStart(); }
            ...
            function a() { S.point = r, t.lineEnd(); }

            function c() { u(), S.point = l, S.lineEnd = s; }

            function l(n, t) { o(f = n, h = t), g = M, p = x, d = b, v = _, m = w, S.point = o; }

            function s() { e(M, x, y, b, _, w, g, p, f, d, v, m, i, t), S.lineEnd = a, a(); }

            var f, h, g, p, d, v, m, y, M, x, b, _, w, S = { point: r, lineStart: u, lineEnd: a, polygonStart: function() { t.polygonStart(), S.lineStart = c; }, polygonEnd: function() { t.polygonEnd(), S.lineStart = u; } };
            return S;
        }
        ...
        return t.precision = function(n) { return arguments.length ? (i = (r = n * n) > 0 && 16, t) : Math.sqrt(r); }, t;
    }

    function ye(n) { this.stream = n; }

    function Me(n) {
        var t = me(function(t, e) { return n([t * na, e * na]); });
        return function(n) {
            var e = new ye(n = t(n));
            return e.point = function(t, e) { n.point(t * Qo, e * Qo); }, e;
        };
    }
    ...
    function be(n) {
        function t(n) { return n = a(n[0] * Qo, n[1] * Qo), [n[0] * h + c, l - n[1] * h]; }

        function e(n) { return n = a.invert((n[0] - c) / h, (l - n[1]) / h), n && [n[0] * na, n[1] * na]; }
        ...
        function u() { return s && (s.valid = !1, s = null), t; }

        var i, o, a, c, l, s, f = me(function(n, t) { return n = i(n, t), [n[0] * h + c, l - n[1] * h]; }), h = 150, g = 480, p = 250, d = 0, v = 0, m = 0, y = 0, M = 0, x = Wa, b = dt, _ = null, w = null;
        return t.stream = function(n) { return s && (s.valid = !1), s = _e(x(o, f(b(n)))), s.valid = !0, s; }, t.clipAngle = function(n) { return arguments.length ? (x = null == n ? (_ = n, Wa) : ee((_ = +n) * Qo), u()) : _; }, t.clipExtent = function(n) { return arguments.length ? (w = n, b = n ? re(n[0][0], n[0][1], n[1][0], n[1][1]) : dt, u()) : w; }, t.scale = function(n) { return arguments.length ? (h = +n, r()) : h; }, t.translate = function(n) { return arguments.length ? (g = +n[0], p = +n[1], r()) : [g, p]; }, t.center = function(n) { return arguments.length ? (d = n[0] % 360 * Qo, v = n[1] % 360 * Qo, r()) : [d * na, v * na]; }, t.rotate = function(n) { return arguments.length ? (m = n[0] % 360 * Qo, y = n[1] % 360 * Qo, M = n.length > 2 ? n[2] % 360 * Qo : 0, r()) : [m * na, y * na, M * na]; }, mo.rebind(t, f, "precision"), function() { return i = n.apply(this, arguments), t.invert = i.invert && e, r(); };
    }

    function _e(n) {
        var t = new ye(n);
        return t.point = function(t, e) { n.point(t * Qo, e * Qo); }, t;
    }

    function we(n, t) { return[n, t]; }

    function Se(n, t) { return[n > Bo ? n - Wo : -Bo > n ? n + Wo : n, t]; }

    function Ee(n, t, e) { return n ? t || e ? ie(Ae(n), Ne(t, e)) : Ae(n) : t || e ? Ne(t, e) : Se; }

    function ke(n) { return function(t, e) { return t += n, [t > Bo ? t - Wo : -Bo > t ? t + Wo : t, e]; }; }
    ...
    function De(n) { return n.source; }

    function je(n) { return n.target; }
    ...
    function He() {
        ...
        var t, e, r;
        ac.point = function(u, i) { t = u * Qo, e = Math.sin(i *= Qo), r = Math.cos(i), ac.point = n; }, ac.lineEnd = function() { ac.point = ac.lineEnd = c; };
    }
    ...
    function Pe(n, t) {
        ...
        var r = Math.cos(n), u = function(n) { return Math.tan(Bo / 4 + n / 2); }, i = n === t ? Math.sin(n) : Math.log(r / Math.cos(t)) / Math.log(u(t) / u(n)), o = r * Math.pow(u(n), i) / i;
    ...
    function Re(n, t) { return[n, Math.log(Math.tan(Bo / 4 + t / 2))]; }
    ...
    function Ge(n, t) { return n.length < 4 ? Xe(n) : n[1] + nr(n.slice(1, n.length - 1), tr(n, t)); }

    function Ke(n, t) { return n.length < 3 ? Xe(n) : n[0] + nr((n.push(n[0]), n), tr([n[n.length - 2]].concat(n, [n[1]]), t)); }

    function Qe(n, t) { return n.length < 3 ? Xe(n) : n[0] + nr(n, tr(n, t)); }
    ...
    function or(n, t) { return n[0] * t[0] + n[1] * t[1] + n[2] * t[2] + n[3] * t[3]; }

    function ar(n, t, e) { n.push("C", or(pc, t), ",", or(pc, e), ",", or(dc, t), ",", or(dc, e), ",", or(vc, t), ",", or(vc, e)); }

    function cr(n, t) { return(t[1] - n[1]) / (t[0] - n[0]); }
    ...
    function fr(n) { return n.length < 3 ? Xe(n) : n[0] + nr(n, sr(n)); }
    ...
    function gr(n, t, e) { return(e[0] - t[0]) * (n[1] - t[1]) < (e[1] - t[1]) * (n[0] - t[0]); }
    ...
    function vr(n, t) {
        var e = { list: n.map(function(n, t) { return{ index: t, x: n[0], y: n[1] }; }).sort(function(n, t) { return n.y < t.y ? -1 : n.y > t.y ? 1 : n.x < t.x ? -1 : n.x > t.x ? 1 : 0; }), bottomSite: null },
            r = {
                ...
                rightRegion: function(n) { return null == n.edge ? e.bottomSite : n.edge.region[yc[n.side]]; }
            },
            u = {
                bisect: function(n, t) {
                ...
                endPoint: function(n, e, r) { n.ep[e] = r, n.ep[yc[e]] && t(n); },
            ...
            i = {
                ...
                empty: function() { return 0 === i.list.length; },
    ...
    function mr(n) { return n.x; }

    function yr(n) { return n.y; }

    function Mr() { return{ leaf: !0, nodes: [], point: null, x: null, y: null }; }
    ...
    function br(n, t) {
        ...
        return function(n) { return"#" + ct(Math.round(e + i * n)) + ct(Math.round(r + o * n)) + ct(Math.round(u + a * n)); };
    }
    ...
    function wr(n, t) { return t -= n = +n, function(e) { return n + t * e; }; }

    function Sr(n, t) {
        var e, r, u, i, o, a = 0, c = 0, l = [], s = [];
        for (n += "", t += "", Mc.lastIndex = 0, r = 0; e = Mc.exec(t); ++r)e.index && l.push(t.substring(a, c = e.index)), s.push({ i: l.length, x: e[0] }), l.push(null), a = Mc.lastIndex;
        for (a < t.length && l.push(t.substring(a)), r = 0, i = s.length; (e = Mc.exec(n)) && i > r; ++r)
            if (o = s[r], o.x == e[0]) {
                if (o.i)
                    if (null == l[o.i + 1])for (l[o.i - 1] += o.x, l.splice(o.i, 1), u = r + 1; i > u; ++u)s[u].i--;
                    else for (l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2), u = r + 1; i > u; ++u)s[u].i -= 2;
                else if (null == l[o.i + 1])l[o.i] = o.x;
                else for (l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1), u = r + 1; i > u; ++u)s[u].i--;
                s.splice(r, 1), i--, r--;
            } else o.x = wr(parseFloat(e[0]), parseFloat(o.x));
        for (; i > r;)o = s.pop(), null == l[o.i + 1] ? l[o.i] = o.x : (l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1)), i--;
        return 1 === l.length ? null == l[0] ? (o = s[0].x, function(n) { return o(n) + ""; }) : function() { return t; } : function(n) {
    ...
    function Ar(n) { return function(t) { return 0 >= t ? 0 : t >= 1 ? 1 : n(t); }; }

    function Nr(n) { return function(t) { return 1 - n(1 - t); }; }

    function Tr(n) { return function(t) { return .5 * (.5 > t ? n(2 * t) : 2 - n(2 - 2 * t)); }; }

    function qr(n) { return n * n; }

    function zr(n) { return n * n * n; }
    ...
    function Dr(n) { return function(t) { return Math.pow(t, n); }; }

    function jr(n) { return 1 - Math.cos(n * Jo); }

    function Lr(n) { return Math.pow(2, 10 * (n - 1)); }

    function Hr(n) { return 1 - Math.sqrt(1 - n * n); }

    function Fr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / Wo * Math.asin(1 / n) : (n = 1, e = t / 4), function(r) { return 1 + n * Math.pow(2, -10 * r) * Math.sin((r - e) * Wo / t); };
    }

    function Pr(n) { return n || (n = 1.70158), function(t) { return t * t * ((n + 1) * t - n); }; }

    function Or(n) { return 1 / 2.75 > n ? 7.5625 * n * n : 2 / 2.75 > n ? 7.5625 * (n -= 1.5 / 2.75) * n + .75 : 2.5 / 2.75 > n ? 7.5625 * (n -= 2.25 / 2.75) * n + .9375 : 7.5625 * (n -= 2.625 / 2.75) * n + .984375; }

    function Rr(n, t) {
        n = mo.hcl(n), t = mo.hcl(t);
        var e = n.h, r = n.c, u = n.l, i = t.h - e, o = t.c - r, a = t.l - u;
        return isNaN(o) && (o = 0, r = isNaN(r) ? t.c : r), isNaN(i) ? (i = 0, e = isNaN(e) ? t.h : e) : i > 180 ? i -= 360 : -180 > i && (i += 360), function(n) { return J(e + i * n, r + o * n, u + a * n) + ""; };
    }

    function Yr(n, t) {
        n = mo.hsl(n), t = mo.hsl(t);
        var e = n.h, r = n.s, u = n.l, i = t.h - e, o = t.s - r, a = t.l - u;
        return isNaN(o) && (o = 0, r = isNaN(r) ? t.s : r), isNaN(i) ? (i = 0, e = isNaN(e) ? t.h : e) : i > 180 ? i -= 360 : -180 > i && (i += 360), function(n) { return $(e + i * n, r + o * n, u + a * n) + ""; };
    }

    function Ir(n, t) {
        n = mo.lab(n), t = mo.lab(t);
        var e = n.l, r = n.a, u = n.b, i = t.l - e, o = t.a - r, a = t.b - u;
        return function(n) { return Q(e + i * n, r + o * n, u + a * n) + ""; };
    }
    ...
    function $r(n, t, e) { return n[0] += e * t[0], n[1] += e * t[1], n; }
    ...
    function Wr(n, t) { return t = t - (n = +n) ? 1 / (t - n) : 0, function(e) { return(e - n) * t; }; }

    function Jr(n, t) { return t = t - (n = +n) ? 1 / (t - n) : 0, function(e) { return Math.max(0, Math.min(1, (e - n) * t)); }; }
    ...
    function nu(n) { n.fixed |= 2; }

    function tu(n) { n.fixed &= -7; }

    function eu(n) { n.fixed |= 4, n.px = n.x, n.py = n.y; }

    function ru(n) { n.fixed &= -5; }
    ...
    function iu(n, t) { return mo.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = lu, n; }

    function ou(n) { return n.children; }

    function au(n) { return n.value; }

    function cu(n, t) { return t.value - n.value; }

    function lu(n) { return mo.merge(n.map(function(n) { return(n.children || []).map(function(t) { return{ source: n, target: t }; }); })); }

    function su(n) { return n.x; }

    function fu(n) { return n.y; }

    function hu(n, t, e) { n.y0 = t, n.y = e; }

    function gu(n) { return mo.range(n.length); }
    ...
    function vu(n) { return n.reduce(mu, 0); }

    function mu(n, t) { return n + t[1]; }

    function yu(n, t) { return Mu(n, Math.ceil(Math.log(t.length) / Math.LN2 + 1)); }
    ...
    function xu(n) { return[mo.min(n), mo.max(n)]; }

    function bu(n, t) { return n.parent == t.parent ? 1 : 2; }
    ...
    function Eu(n, t) { return n.x - t.x; }

    function ku(n, t) { return t.x - n.x; }

    function Au(n, t) { return n.depth - t.depth; }
    ...
    function Tu(n) { for (var t, e = 0, r = 0, u = n.children, i = u.length; --i >= 0;)t = u[i]._tree, t.prelim += e, t.mod += e, e += t.shift + (r += t.change); }
    ...
    function zu(n, t, e) { return n._tree.ancestor.parent == t.parent ? n._tree.ancestor : e; }

    function Cu(n, t) { return n.value - t.value; }
    ...
    function ju(n, t) { n._pack_next = t, t._pack_prev = n; }
    ...
    function Fu(n) { n._pack_next = n._pack_prev = n; }

    function Pu(n) { delete n._pack_next, delete n._pack_prev; }
    ...
    function Yu(n) { return 1 + mo.max(n, function(n) { return n.y; }); }

    function Iu(n) { return n.reduce(function(n, t) { return n + t.x; }, 0) / n.length; }
    ...
    function Vu(n) { return{ x: n.x, y: n.y, dx: n.dx, dy: n.dy }; }
    ...
    function Bu(n) { return n.rangeExtent ? n.rangeExtent() : $u(n.range()); }
    ...
    function Gu(n) { return n ? { floor: function(t) { return Math.floor(t / n) * n; }, ceil: function(t) { return Math.ceil(t / n) * n; } } : Tc; }
    ...
    function ni(n, t) { return mo.rebind(n, t, "range", "rangeRound", "interpolate", "clamp"); }

    function ti(n, t) { return Ju(n, Gu(ei(n, t)[2])); }
    ...
    function ri(n, t) { return mo.range.apply(mo, ei(n, t)); }

    function ui(n, t, e) {
        var r = -Math.floor(Math.log(ei(n, t)[2]) / Math.LN10 + .01);
        return mo.format(e ? e.replace(Aa, function(n, t, e, u, i, o, a, c, l, s) { return[t, e, u, i, o, a, c, l || "." + (r - 2 * ("%" === s)), s].join(""); }) : ",." + r + "f");
    }

    function ii(n, t, e, r) {
        function u(n) { return(e ? Math.log(0 > n ? 0 : n) : -Math.log(n > 0 ? 0 : -n)) / Math.log(t); }

        function i(n) { return e ? Math.pow(t, n) : -Math.pow(t, -n); }

        function o(t) { return n(u(t)); }

        return o.invert = function(t) { return i(n.invert(t)); }, o.domain = function(t) { return arguments.length ? (e = t[0] >= 0, n.domain((r = t.map(Number)).map(u)), o) : r; }, o.base = function(e) { return arguments.length ? (t = +e, n.domain(r.map(u)), o) : t; }, o.nice = function() {
            ...
            return function(n) { return n / i(c(u(n) + r)) <= a ? t(n) : ""; };
        }, o.copy = function() { return ii(n.copy(), t, e, r); }, ni(o, n);
    }

    function oi(n, t, e) {
        function r(t) { return n(u(t)); }

        var u = ai(t), i = ai(1 / t);
        return r.invert = function(t) { return i(n.invert(t)); }, r.domain = function(t) { return arguments.length ? (n.domain((e = t.map(Number)).map(u)), r) : e; }, r.ticks = function(n) { return ri(e, n); }, r.tickFormat = function(n, t) { return ui(e, n, t); }, r.nice = function(n) { return r.domain(ti(e, n)); }, r.exponent = function(o) { return arguments.length ? (u = ai(t = o), i = ai(1 / t), n.domain(e.map(u)), r) : t; }, r.copy = function() { return oi(n.copy(), t, e); }, ni(r, n);
    }

    function ai(n) { return function(t) { return 0 > t ? -Math.pow(-t, n) : Math.pow(t, n); }; }

    function ci(n, t) {
        function e(e) { return o[((i.get(e) || "range" === t.t && i.set(e, n.push(e))) - 1) % o.length]; }

        function r(t, e) { return mo.range(n.length).map(function(n) { return t + e * n; }); }
        ...
        }, e.range = function(n) { return arguments.length ? (o = n, a = 0, t = { t: "range", a: arguments }, e) : o; }, e.rangePoints = function(u, i) {
        ...
        }, e.rangeBand = function() { return a; }, e.rangeExtent = function() { return $u(t.a[0]); }, e.copy = function() { return ci(n, t); }, e.domain(n);
    }
    ...
    function li(n, t) {
        ...
        function r(n) { return isNaN(n = +n) ? void 0 : t[mo.bisect(u, n)]; }
    ...
    function si(n, t, e) {
        function r(t) { return e[Math.max(0, Math.min(o, Math.floor(i * (t - n))))]; }

        function u() { return i = e.length / (t - n), o = e.length - 1, r; }

        var i, o;
        return r.domain = function(e) { return arguments.length ? (n = +e[0], t = +e[e.length - 1], u()) : [n, t]; }, r.range = function(n) { return arguments.length ? (e = n, u()) : e; }, r.invertExtent = function(t) { return t = e.indexOf(t), t = 0 > t ? 0 / 0 : t / i + n, [t, t + 1 / i]; }, r.copy = function() { return si(n, t, e); }, u();
    }

    function fi(n, t) {
        function e(e) { return e >= e ? t[mo.bisect(n, e)] : void 0; }

        return e.domain = function(t) { return arguments.length ? (n = t, e) : n; }, e.range = function(n) { return arguments.length ? (t = n, e) : t; }, e.invertExtent = function(e) { return e = t.indexOf(e), [n[e - 1], n[e]]; }, e.copy = function() { return fi(n, t); }, e;
    }

    function hi(n) {
        function t(n) { return+n; }

        return t.invert = t, t.domain = t.range = function(e) { return arguments.length ? (n = e.map(t), t) : n; }, t.ticks = function(t) { return ri(n, t); }, t.tickFormat = function(t, e) { return ui(n, t, e); }, t.copy = function() { return hi(n); }, t;
    }

    function gi(n) { return n.innerRadius; }

    function pi(n) { return n.outerRadius; }

    function di(n) { return n.startAngle; }

    function vi(n) { return n.endAngle; }
    ...
    function yi(n) {
        function t(t) {
            function c() { d.push("M", a(n(m), f), s, l(n(v.reverse()), f), "Z"); }

            for (var h, g, p, d = [], v = [], m = [], y = -1, M = t.length, x = pt(e), b = pt(u), _ = e === r ? function() { return g; } : pt(r), w = u === i ? function() { return p; } : pt(i); ++y < M;)o.call(this, h = t[y], y) ? (v.push([g = +x.call(this, h, y), p = +b.call(this, h, y)]), m.push([+_.call(this, h, y), +w.call(this, h, y)])) : v.length && (c(), v = [], m = []);
    ...
    function Mi(n) { return n.radius; }

    function xi(n) { return[n.x, n.y]; }
    ...
    function _i() { return 64; }

    function wi() { return"circle"; }
    ...
    function Ei(n, t) { return Lo(n, Uc), n.id = t, n; }

    function ki(n, t, e, r) {
        var u = n.id;
        return N(n, "function" == typeof e ? function(n, i, o) { n.__transition__[u].tween.set(t, r(e.call(n, n.__data__, i, o))); } : (e = r(e), function(n) { n.__transition__[u].tween.set(t, e); }));
    }

    function Ai(n) { return null == n && (n = ""), function() { this.textContent = n; }; }
    ...
    function Ni(n, t, e, r) {
        ...
        if (!o) {
            ...
            o = i[e] = { tween: new u, time: a, ease: r.ease, delay: r.delay, duration: r.duration }, ++i.count, mo.timer(function(r) {
                function u(r) { return i.active > e ? l() : (i.active = e, o.event && o.event.start.call(n, s, t), o.tween.forEach(function(e, r) { (r = r.call(n, s, t)) && p.push(r); }), c(r || 1) ? 1 : (xt(c, h, a), void 0)); }
                ...
                function l() { return--i.count ? delete i[e] : delete n.__transition__, 1; }
    ...
    function Ti(n, t) { n.attr("transform", function(n) { return"translate(" + t(n) + ",0)"; }); }

    function qi(n, t) { n.attr("transform", function(n) { return"translate(0," + t(n) + ")"; }); }

    function zi() { this._ = new Date(arguments.length > 1 ? Date.UTC.apply(this, arguments) : arguments[0]); }
    ...
    function Ci(n, t, e) {
        ...
        function u(e) { return t(e = n(new Jc(e - 1)), 1), e; }

        function i(n, e) { return t(n = new Jc(+n), e), n; }
    ...
    function Hi(n) { return new RegExp("^(?:" + n.map(mo.requote).join("|") + ")", "i"); }
    ...
    function Xi(n, t, e) { return Li(n, vl.c.toString(), t, e); }

    function $i(n, t, e) { return Li(n, vl.x.toString(), t, e); }

    function Bi(n, t, e) { return Li(n, vl.X.toString(), t, e); }
    ...
    function Gi(n, t, e) { return/^[+-]\d{4}$/.test(t = t.substring(e, e + 5)) ? (n.Z = +t, e + 5) : -1; }

    function Ki(n) { return n + (n > 68 ? 1900 : 2e3); }
    ...
    function so(n) { return n.toISOString(); }
    ...
    function fo(n, t, e) {
        ...
        function u(n, e) {
            ...
            return i == bl.length ? [t.year, ei(n.map(function(n) { return n / 31536e6; }), e)[2]] : i ? t[u / bl[i - 1] < bl[i] / u ? i - 1 : i] : [El, ei(n, e)[2]];
        }

        return r.invert = function(t) { return ho(n.invert(t)); }, r.domain = function(t) { return arguments.length ? (n.domain(t), r) : n.domain().map(ho); }, r.nice = function(n, t) {
            function e(e) { return!isNaN(e) && !n.range(e, ho(+e + 1), t).length; }
        ...
        }, r.tickFormat = function() { return e; }, r.copy = function() { return fo(n.copy(), t, e); }, ni(r, n);
    }

    function ho(n) { return new Date(n); }
    ...
    function po(n) { return JSON.parse(n.responseText); }
    ...
    var yo = [].slice, Mo = function(n) { return yo.call(n); }, xo = document, bo = xo.documentElement, _o = window;
    try {
    ...
    try {
        ...
        Eo.setAttribute = function(n, t) { ko.call(this, n, t + ""); }, Eo.setAttributeNS = function(n, t, e) { Ao.call(this, n, t, e + ""); }, No.setProperty = function(n, t, e) { To.call(this, n, t + "", e); };
    }
    mo.ascending = function(n, t) { return t > n ? -1 : n > t ? 1 : n >= t ? 0 : 0 / 0; }, mo.descending = function(n, t) { return n > t ? -1 : t > n ? 1 : t >= n ? 0 : 0 / 0; }, mo.min = function(n, t) {
        ...
        if (1 === arguments.length)for (; ++i < u;)isNaN(e = +n[i]) || (r += e);
        else for (; ++i < u;)isNaN(e = +t.call(n, n[i], i)) || (r += e);
        return r;
    }, mo.mean = function(t, e) {
        var r, u = t.length, i = 0, o = -1, a = 0;
        if (1 === arguments.length)for (; ++o < u;)n(r = t[o]) && (i += (r - i) / ++a);
        else for (; ++o < u;)n(r = e.call(t, t[o], o)) && (i += (r - i) / ++a);
        return a ? i : void 0;
    }, mo.quantile = function(n, t) {
        var e = (n.length - 1) * t + 1, r = Math.floor(e), u = +n[r - 1], i = e - r;
        return i ? u + i * (n[r] - u) : u;
    }, mo.median = function(t, e) { return arguments.length > 1 && (t = t.map(e)), t = t.filter(n), t.length ? mo.quantile(t.sort(mo.ascending), .5) : void 0; }, mo.bisector = function(n) {
        return{
    ...
    var qo = mo.bisector(function(n) { return n; });
    mo.bisectLeft = qo.left, mo.bisect = mo.bisectRight = qo.right, mo.shuffle = function(n) {
        ...
        return r;
    }, mo.transpose = function(n) { return mo.zip.apply(mo, n); }, mo.keys = function(n) {
        var t = [];
        ...
        return t;
    }, mo.merge = function(n) { return Array.prototype.concat.apply([], n); }, mo.range = function(n, t, r) {
        if (arguments.length < 3 && (r = 1, arguments.length < 2 && (t = n, n = 0)), 1 / 0 === (t - n) / r)throw new Error("infinite range");
        var u, i = [], o = e(Math.abs(r)), a = -1;
        if (n *= o, t *= o, r *= o, 0 > r)for (; (u = n + r * ++a) > t;)i.push(u / o);
        else for (; (u = n + r * ++a) < t;)i.push(u / o);
        return i;
    }, mo.map = function(n) {
        var t = new u;
        if (n instanceof u)n.forEach(function(n, e) { t.set(n, e); });
        else for (var e in n)t.set(e, n[e]);
        return t;
    }, r(u, {
        has: function(n) { return zo + n in this; },
        get: function(n) { return this[zo + n]; },
        set: function(n, t) { return this[zo + n] = t; },
        remove: function(n) { return n = zo + n, n in this && delete this[n]; },
        keys: function() {
            var n = [];
            return this.forEach(function(t) { n.push(t); }), n;
        },
        values: function() {
            var n = [];
            return this.forEach(function(t, e) { n.push(e); }), n;
        },
        entries: function() {
            var n = [];
            return this.forEach(function(t, e) { n.push({ key: t, value: e }); }), n;
        },
        forEach: function(n) { for (var t in this)t.charCodeAt(0) === Co && n.call(this, t.substring(1), this[t]); }
    });
    ...
    mo.nest = function() {
        function n(t, a, c) {
            ...
            return t ? (s = t(), f = function(e, r) { s.set(e, n(t, r, c)); }) : (s = {}, f = function(e, r) { s[e] = n(t, r, c); }), v.forEach(f), s;
        }

        function t(n, e) {
            if (e >= o.length)return n;
            var r = [], u = a[e++];
            return n.forEach(function(n, u) { r.push({ key: n, values: t(u, e) }); }), u ? r.sort(function(n, t) { return u(n.key, t.key); }) : r;
        }

        var e, r, i = {}, o = [], a = [];
        return i.map = function(t, e) { return n(e, t, 0); }, i.entries = function(e) { return t(n(mo.map, e, 0), 0); }, i.key = function(n) { return o.push(n), i; }, i.sortKeys = function(n) { return a[o.length - 1] = n, i; }, i.sortValues = function(n) { return e = n, i; }, i.rollup = function(n) { return r = n, i; }, i;
    }, mo.set = function(n) {
        var t = new i;
        ...
        has: function(n) { return zo + n in this; },
        add: function(n) { return this[zo + n] = !0, n; },
        remove: function(n) { return n = zo + n, n in this && delete this[n]; },
        values: function() {
            var n = [];
            return this.forEach(function(t) { n.push(t); }), n;
        },
        forEach: function(n) { for (var t in this)t.charCodeAt(0) === Co && n.call(this, t.substring(1)); }
    ...
    }, mo.event = null, mo.requote = function(n) { return n.replace(jo, "\\$&"); };
    var jo = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g, Lo = {}.__proto__ ? function(n, t) { n.__proto__ = t; } : function(n, t) { for (var e in t)n[e] = t[e]; }, Ho = function(n, t) { return t.querySelector(n); }, Fo = function(n, t) { return t.querySelectorAll(n); }, Po = bo[a(bo, "matchesSelector")], Oo = function(n, t) { return Po.call(n, t); };
    "function" == typeof Sizzle && (Ho = function(n, t) { return Sizzle(n, t)[0] || null; }, Fo = function(n, t) { return Sizzle.uniqueSort(Sizzle(n, t)); }, Oo = Sizzle.matchesSelector), mo.selection = function() { return Uo; };
    ...
    mo.ns = {
    ...
    }, Ro.append = function(n) { return n = S(n), this.select(function() { return this.appendChild(n.apply(this, arguments)); }); }, Ro.insert = function(n, t) { return n = S(n), t = d(t), this.select(function() { return this.insertBefore(n.apply(this, arguments), t.apply(this, arguments)); }); }, Ro.remove = function() {
        ...
        var c = T([]), l = p([]), s = p([]);
        if ("function" == typeof n)for (; ++o < a;)e(r = this[o], n.call(r, r.parentNode.__data__, o));
        else for (; ++o < a;)e(r = this[o], n);
        return l.enter = function() { return c; }, l.exit = function() { return s; }, l;
    }, Ro.datum = function(n) { return arguments.length ? this.property("__data__", n) : this.property("__data__"); }, Ro.filter = function(n) {
        var t, e, r, u = [];
        ...
        return this.order();
    }, Ro.each = function(n) { return N(this, function(t, e, r) { n.call(t, t.__data__, e, r); }); }, Ro.call = function(n) {
        var t = Mo(arguments);
        return n.apply(t[0] = this, t), this;
    }, Ro.empty = function() { return!this.node(); }, Ro.node = function() {
    ...
    mo.selection.enter = T, mo.selection.enter.prototype = Io, Io.append = Ro.append, Io.empty = Ro.empty, Io.node = Ro.node, Io.call = Ro.call, Io.size = Ro.size, Io.select = function(n) {
        ...
        return p(o);
    }, Io.insert = function(n, t) { return arguments.length < 2 && (t = q(this)), Ro.insert.call(this, n, t); }, Ro.transition = function() {
        ...
        return Ei(r, e);
    }, Ro.interrupt = function() { return this.each(z); }, mo.select = function(n) {
    ...
    Zo.forEach(function(n) { "on" + n in xo && Zo.remove(n); });
    ...
    mo.touches = function(n, t) {
        ...
        function n() { this.on("mousedown.drag", o).on("touchstart.drag", a); }

        function t() { return mo.event.changedTouches[0].identifier; }

        function e(n, t) { return mo.touches(n).filter(function(n) { return n.identifier === t; })[0]; }
        ...
        function r(n, t, e, r) {
            return function() {
                ...
                function a() { m.on(e + "." + p, null).on(r + "." + p, null), y(v && mo.event.target === h), f({ type: "dragend" }); }
        ...
        return n.origin = function(t) { return arguments.length ? (i = t, n) : i; }, mo.rebind(n, u, "on");
    };
    ...
    mo.interpolateZoom = function(n, t) {
        ...
        function n(n) { n.on(A, l).on(oa + ".zoom", h).on(N, p).on("dblclick.zoom", d).on(q, s); }

        function t(n) { return[(n[0] - S.x) / S.k, (n[1] - S.y) / S.k]; }

        function e(n) { return[n[0] * S.k + S.x, n[1] * S.k + S.y]; }

        function r(n) { S.k = Math.max(k[0], Math.min(k[1], n)); }

        function u(n, t) { t = e(t), S.x += n[0] - t[0], S.y += n[1] - t[1]; }

        function i() { b && b.domain(x.range().map(function(n) { return(n - S.x) / S.k; }).map(x.invert)), w && w.domain(_.range().map(function(n) { return(n - S.y) / S.k; }).map(_.invert)); }
        ...
        function l() {
            function n() { s = 1, u(mo.mouse(r), h), a(i); }

            function e() { f.on(N, _o === r ? p : null).on(T, null), g(s && mo.event.target === l), c(i); }
        ...
        function s() {
            function n() {
                var n = mo.touches(p);
                return g = S.k, n.forEach(function(n) { n.identifier in v && (v[n.identifier] = t(n)); }), n;
            }
        ...
        function h() {
            ...
            y ? clearTimeout(y) : (z.call(this), o(n)), y = setTimeout(function() { y = null, c(n); }, 50), f();
        ...
        var v, m, y, M, x, b, _, w, S = { x: 0, y: 0, k: 1 }, E = [960, 500], k = ia, A = "mousedown.zoom", N = "mousemove.zoom", T = "mouseup.zoom", q = "touchstart.zoom", C = g(n, "zoomstart", "zoom", "zoomend");
        return n.event = function(n) {
            n.each(function() {
                var n = C.of(this, arguments), t = S;
                Oc ? mo.select(this).transition().each("start.zoom", function() { S = this.__chart__ || { x: 0, y: 0, k: 1 }, o(n); }).tween("zoom:zoom", function() {
                ...
                }).each("end.zoom", function() { c(n); }) : (this.__chart__ = S, o(n), a(n), c(n));
            });
    ...
    }, pa.darker = function(n) { return n = Math.pow(.7, arguments.length ? n : 1), ot(~~(n * this.r), ~~(n * this.g), ~~(n * this.b)); }, pa.hsl = function() { return st(this.r, this.g, this.b); }, pa.toString = function() { return"#" + ct(this.r) + ct(this.g) + ct(this.b); };
    ...
    da.forEach(function(n, t) { da.set(n, ut(t)); }), mo.functor = pt, mo.xhr = vt(dt), mo.dsv = function(n, t) {
        function e(n, e, i) {
            arguments.length < 3 && (i = e, e = null);
            var o = mo.xhr(n, t, i);
            return o.row = function(n) { return arguments.length ? o.response(null == (e = n) ? r : u(n)) : e; }, o.row(e);
        }
        ...
        function o(t) { return t.map(a).join(n); }

        function a(n) { return c.test(n) ? '"' + n.replace(/\"/g, '""') + '"' : n; }
    ...
    var va, ma, ya, Ma, xa, ba = _o[a(_o, "requestAnimationFrame")] || function(n) { setTimeout(n, 17); };
    ...
    }, mo.round = function(n, t) { return t ? Math.round(n * (t = Math.pow(10, t))) / t : Math.round(n); }, mo.format = function(n) {
    ...
    var Aa = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i, Na = mo.map({ b: function(n) { return n.toString(2); }, c: function(n) { return String.fromCharCode(n); }, o: function(n) { return n.toString(8); }, x: function(n) { return n.toString(16); }, X: function(n) { return n.toString(16).toUpperCase(); }, g: function(n, t) { return n.toPrecision(t); }, e: function(n, t) { return n.toExponential(t); }, f: function(n, t) { return n.toFixed(t); }, r: function(n, t) { return(n = mo.round(n, St(n, t))).toFixed(Math.max(0, Math.min(20, St(n * (1 + 1e-15), t)))); } }), Ta = dt;
    if (Sa) {
        var qa = Sa.length;
        Ta = function(n) {
    ...
    mo.geo = {}, kt.prototype = { s: 0, t: 0, add: function(n) { At(n, this.t, za), At(za.s, this.s, this), this.s ? this.t += za.t : this.s = za.t; }, reset: function() { this.s = this.t = 0; }, valueOf: function() { return this.s; } };
    var za = new kt;
    mo.geo.stream = function(n, t) { n && Ca.hasOwnProperty(n.type) ? Ca[n.type](n, t) : Nt(n, t); };
    ...
    mo.geo.area = function(n) { return ja = 0, mo.geo.stream(n, Ha), ja; };
    var ja,
        La = new kt,
        Ha = {
            sphere: function() { ja += 4 * Bo; },
            point: c,
            lineStart: c,
            lineEnd: c,
            polygonStart: function() { La.reset(), Ha.lineStart = zt; },
            polygonEnd: function() {
                var n = 2 * La;
    ...
    mo.geo.bounds = function() {
        ...
        function r() { x[0] = s, x[1] = h, b.point = n, m = null; }
        ...
        function i() { Ha.lineStart(); }

        function o() { u(d, v), Ha.lineEnd(), Math.abs(y) > Go && (s = -(h = 180)), x[0] = s, x[1] = h, m = null; }
        ...
        var s, f, h, g, p, d, v, m, y, M, x, b = { point: n, lineStart: e, lineEnd: r, polygonStart: function() { b.point = u, b.lineStart = i, b.lineEnd = o, y = 0, Ha.polygonStart(); }, polygonEnd: function() { Ha.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r, 0 > La ? (s = -(h = 180), f = -(g = 90)) : y > Go ? g = 90 : -Go > y && (f = -90), x[0] = s, x[1] = h; } };
        return function(n) {
    ...
    var Fa, Pa, Oa, Ra, Ya, Ia, Ua, Za, Va, Xa, $a, Ba = { sphere: c, point: Rt, lineStart: It, lineEnd: Ut, polygonStart: function() { Ba.lineStart = Zt; }, polygonEnd: function() { Ba.lineStart = It; } }, Wa = Bt(Vt, Qt, te, [-Bo, -Bo / 2]), Ja = 1e9;
    mo.geo.clipExtent = function() {
        var n, t, e, r, u, i, o = { stream: function(n) { return u && (u.valid = !1), u = i(n), u.valid = !0, u; }, extent: function(a) { return arguments.length ? (i = re(n = +a[0][0], t = +a[0][1], e = +a[1][0], r = +a[1][1]), u && (u.valid = !1, u = null), o) : [[n, t], [e, r]]; } };
        return o.extent([[0, 0], [960, 500]]);
    }, (mo.geo.conicEqualArea = function() { return oe(ae); }).raw = ae, mo.geo.albers = function() { return mo.geo.conicEqualArea().rotate([96, 0]).center([-.6, 38.7]).parallels([29.5, 45.5]).scale(1070); }, mo.geo.albersUsa = function() {
        function n(n) {
            var i = n[0], o = n[1];
            return t = null, e(i, o), t || (r(i, o), t) || u(i, o), t;
        }

        var t, e, r, u, i = mo.geo.albers(), o = mo.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), a = mo.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = { point: function(n, e) { t = [n, e]; } };
        return n.invert = function(n) {
            var t = i.scale(), e = i.translate(), r = (n[0] - e[0]) / t, u = (n[1] - e[1]) / t;
            return(u >= .12 && .234 > u && r >= -.425 && -.214 > r ? o : u >= .166 && .234 > u && r >= -.214 && -.115 > r ? a : i).invert(n);
        }, n.stream = function(n) {
            var t = i.stream(n), e = o.stream(n), r = a.stream(n);
            return{ point: function(n, u) { t.point(n, u), e.point(n, u), r.point(n, u); }, sphere: function() { t.sphere(), e.sphere(), r.sphere(); }, lineStart: function() { t.lineStart(), e.lineStart(), r.lineStart(); }, lineEnd: function() { t.lineEnd(), e.lineEnd(), r.lineEnd(); }, polygonStart: function() { t.polygonStart(), e.polygonStart(), r.polygonStart(); }, polygonEnd: function() { t.polygonEnd(), e.polygonEnd(), r.polygonEnd(); } };
        }, n.precision = function(t) { return arguments.length ? (i.precision(t), o.precision(t), a.precision(t), n) : i.precision(); }, n.scale = function(t) { return arguments.length ? (i.scale(t), o.scale(.35 * t), a.scale(t), n.translate(i.translate())) : i.scale(); }, n.translate = function(t) {
    ...
    var Ga, Ka, Qa, nc, tc, ec, rc = { point: c, lineStart: c, lineEnd: c, polygonStart: function() { Ka = 0, rc.lineStart = ce; }, polygonEnd: function() { rc.lineStart = rc.lineEnd = rc.point = c, Ga += Math.abs(Ka / 2); } }, uc = { point: le, lineStart: c, lineEnd: c, polygonStart: c, polygonEnd: c }, ic = { point: he, lineStart: ge, lineEnd: pe, polygonStart: function() { ic.lineStart = de; }, polygonEnd: function() { ic.point = he, ic.lineStart = ge, ic.lineEnd = pe; } };
    mo.geo.transform = function(n) {
    ...
    }, ye.prototype = { point: function(n, t) { this.stream.point(n, t); }, sphere: function() { this.stream.sphere(); }, lineStart: function() { this.stream.lineStart(); }, lineEnd: function() { this.stream.lineEnd(); }, polygonStart: function() { this.stream.polygonStart(); }, polygonEnd: function() { this.stream.polygonEnd(); } }, mo.geo.path = function() {
        function n(n) { return n && ("function" == typeof a && i.pointRadius(+a.apply(this, arguments)), o && o.valid || (o = u(i)), mo.geo.stream(n, o)), i.result(); }

        function t() { return o = null, n; }

        var e, r, u, i, o, a = 4.5;
        return n.area = function(n) { return Ga = 0, mo.geo.stream(n, u(rc)), Ga; }, n.centroid = function(n) { return Oa = Ra = Ya = Ia = Ua = Za = Va = Xa = $a = 0, mo.geo.stream(n, u(ic)), $a ? [Va / $a, Xa / $a] : Za ? [Ia / Za, Ua / Za] : Ya ? [Oa / Ya, Ra / Ya] : [0 / 0, 0 / 0]; }, n.bounds = function(n) { return tc = ec = -(Qa = nc = 1 / 0), mo.geo.stream(n, u(uc)), [[Qa, nc], [tc, ec]]; }, n.projection = function(n) { return arguments.length ? (u = (e = n) ? n.stream || Me(n) : dt, t()) : e; }, n.context = function(n) { return arguments.length ? (i = null == (r = n) ? new se : new ve(n), "function" != typeof a && i.pointRadius(a), t()) : r; }, n.pointRadius = function(t) { return arguments.length ? (a = "function" == typeof t ? t : (i.pointRadius(+t), +t), n) : a; }, n.projection(mo.geo.albersUsa()).context(null);
    }, mo.geo.projection = xe, mo.geo.projectionMutator = be, (mo.geo.equirectangular = function() { return xe(we); }).raw = we.invert = we, mo.geo.rotation = function(n) {
        function t(t) { return t = n(t[0] * Qo, t[1] * Qo), t[0] *= na, t[1] *= na, t; }

        return n = Ee(n[0] % 360 * Qo, n[1] * Qo, n.length > 2 ? n[2] * Qo : 0), t.invert = function(t) { return t = n.invert(t[0] * Qo, t[1] * Qo), t[0] *= na, t[1] *= na, t; }, t;
    }, Se.invert = we, mo.geo.circle = function() {
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r, t = Ee(-n[0] * Qo, -n[1] * Qo, 0).invert, u = [];
            return e(null, null, 1, { point: function(n, e) { u.push(n = t(n, e)), n[0] *= na, n[1] *= na; } }), { type: "Polygon", coordinates: [u] };
        }

        var t, e, r = [0, 0], u = 6;
        return n.origin = function(t) { return arguments.length ? (r = t, n) : r; }, n.angle = function(r) { return arguments.length ? (e = Te((t = +r) * Qo, u * Qo), n) : t; }, n.precision = function(r) { return arguments.length ? (e = Te(t * Qo, (u = +r) * Qo), n) : u; }, n.angle(90);
        ...
        function t() {
            ...
            }).map(s)).concat(mo.range(Math.ceil(a / d) * d, o, d).filter(function(n) { return Math.abs(n % m) > Go; }).map(f));
        }
        ...
        function n() { return{ type: "LineString", coordinates: [t || r.apply(this, arguments), e || u.apply(this, arguments)] }; }

        var t, e, r = De, u = je;
        return n.distance = function() { return mo.geo.distance(t || r.apply(this, arguments), e || u.apply(this, arguments)); }, n.source = function(e) { return arguments.length ? (r = e, t = "function" == typeof e ? null : e, n) : r; }, n.target = function(t) { return arguments.length ? (u = t, e = "function" == typeof t ? null : t, n) : u; }, n.precision = function() { return arguments.length ? n : 0; }, n;
    }, mo.geo.interpolate = function(n, t) { return Le(n[0] * Qo, n[1] * Qo, t[0] * Qo, t[1] * Qo); }, mo.geo.length = function(n) { return oc = 0, mo.geo.stream(n, ac), oc; };
    var oc, ac = { sphere: c, point: c, lineStart: He, lineEnd: c, polygonStart: c, polygonEnd: c }, cc = Fe(function(n) { return Math.sqrt(2 / (1 + n)); }, function(n) { return 2 * Math.asin(n / 2); });
    (mo.geo.azimuthalEqualArea = function() { return xe(cc); }).raw = cc;
    var lc = Fe(function(n) {
        var t = Math.acos(n);
        return t && t / Math.sin(t);
    }, dt);
    (mo.geo.azimuthalEquidistant = function() { return xe(lc); }).raw = lc, (mo.geo.conicConformal = function() { return oe(Pe); }).raw = Pe, (mo.geo.conicEquidistant = function() { return oe(Oe); }).raw = Oe;
    var sc = Fe(function(n) { return 1 / n; }, Math.atan);
    (mo.geo.gnomonic = function() { return xe(sc); }).raw = sc, Re.invert = function(n, t) { return[n, 2 * Math.atan(Math.exp(t)) - Jo]; }, (mo.geo.mercator = function() { return Ye(Re); }).raw = Re;
    var fc = Fe(function() { return 1; }, Math.asin);
    (mo.geo.orthographic = function() { return xe(fc); }).raw = fc;
    var hc = Fe(function(n) { return 1 / (1 + n); }, function(n) { return 2 * Math.atan(n); });
    (mo.geo.stereographic = function() { return xe(hc); }).raw = hc, Ie.invert = function(n, t) { return[Math.atan2(R(n), Math.cos(t)), O(Math.sin(t) / Y(n))]; }, (mo.geo.transverseMercator = function() { return Ye(Ie); }).raw = Ie, mo.geom = {}, mo.svg = {}, mo.svg.line = function() { return Ue(dt); };
    var gc = mo.map({ linear: Xe, "linear-closed": $e, step: Be, "step-before": We, "step-after": Je, basis: er, "basis-open": rr, "basis-closed": ur, bundle: ir, cardinal: Qe, "cardinal-open": Ge, "cardinal-closed": Ke, monotone: fr });
    gc.forEach(function(n, t) { t.key = n, t.closed = /-closed$/.test(n); });
    ...
    mo.geom.hull = function(n) {
        function t(n) {
            ...
            if (d === Ze && r === Ve)t = n;
            else for (i = 0, t = []; m > i; ++i)t.push([+d.call(this, u = n[i], i), +v.call(this, u, i)]);
            for (i = 1; m > i; ++i)(t[i][1] < t[b][1] || t[i][1] == t[b][1] && t[i][0] < t[b][0]) && (b = i);
            for (i = 0; m > i; ++i)i !== b && (c = t[i][1] - t[b][1], a = t[i][0] - t[b][0], M.push({ angle: Math.atan2(c, a), index: i }));
            for (M.sort(function(n, t) { return n.angle - t.angle; }), g = M[0].angle, h = M[0].index, f = 0, i = 1; y > i; ++i) {
    ...
    }, mo.geom.polygon = function(n) { return Lo(n, mc), n; };
    ...
    mc.area = function() {
        ...
        var t = n.map(function() { return[]; }), e = [];
        return vr(n, function(e) { t[e.region.l.index].push(n[e.region.r.index]); }), t.forEach(function(t, r) {
            var u = n[r], i = u[0], o = u[1];
            t.forEach(function(n) { n.angle = Math.atan2(n[0] - i, n[1] - o); }), t.sort(function(n, t) { return n.angle - t.angle; });
            for (var a = 0, c = t.length - 1; c > a; a++)e.push([u, t[a], t[a + 1]]);
        }), e;
    }, mo.geom.voronoi = function(n) {
        function t(n) {
            var t, i, o, a = n.map(function() { return[]; }), c = pt(e), l = pt(r), s = n.length, f = 1e6;
            if (c === Ze && l === Ve)t = n;
            else for (t = new Array(s), o = 0; s > o; ++o)t[o] = [+c.call(this, i = n[o], o), +l.call(this, i, o)];
            if (vr(t, function(n) {
                var t, e, r, u, i, o;
                ...
                var r = t[e][0], u = t[e][1], i = n.map(function(n) { return Math.atan2(n[0] - r, n[1] - u); }), o = mo.range(n.length).sort(function(n, t) { return i[n] - i[t]; });
                return o.filter(function(n, t) { return!t || i[n] - i[o[t - 1]] > Go; }).map(function(t) { return n[t]; });
        ...
        return arguments.length ? t(n) : (t.x = function(n) { return arguments.length ? (e = n, t) : e; }, t.y = function(n) { return arguments.length ? (r = n, t) : r; }, t.clipExtent = function(n) {
            ...
            return t;
        }, t.size = function(n) { return arguments.length ? t.clipExtent(n && [[0, 0], n]) : u && u[2]; }, t.links = function(n) {
            var t, u, i, o = n.map(function() { return[]; }), a = [], c = pt(e), l = pt(r), s = n.length;
            if (c === Ze && l === Ve)t = n;
            else for (t = new Array(s), i = 0; s > i; ++i)t[i] = [+c.call(this, u = n[i], i), +l.call(this, u, i)];
            ...
            return mo.geom.delaunay(u).map(function(n) { return n.map(function(n) { return n.data; }); });
        }, t);
    };
    var yc = { l: "r", r: "l" };
    mo.geom.quadtree = function(n, t, e, r, u) {
        function i(n) {
            ...
            else if (m = y = -(d = v = 1 / 0), f = [], h = [], p = n.length, o)for (g = 0; p > g; ++g)s = n[g], s.x < d && (d = s.x), s.y < v && (v = s.y), s.x > m && (m = s.x), s.y > y && (y = s.y), f.push(s.x), h.push(s.y);
            else
                for (g = 0; p > g; ++g) {
            ...
            w > S ? y = v + w : m = d + S;
            var E = Mr();
            if (E.add = function(n) { i(E, n, +M(n, ++g), +x(n, g), d, v, m, y); }, E.visit = function(n) { xr(n, E, d, v, m, y); }, g = -1, null == t) {
        ...
        var o, a = Ze, c = Ve;
        return(o = arguments.length) ? (a = mr, c = yr, 3 === o && (u = e, r = t, e = t = 0), i(n)) : (i.x = function(n) { return arguments.length ? (a = n, i) : a; }, i.y = function(n) { return arguments.length ? (c = n, i) : c; }, i.extent = function(n) { return arguments.length ? (null == n ? t = e = r = u = null : (t = +n[0][0], e = +n[0][1], r = +n[1][0], u = +n[1][1]), i) : null == t ? null : [[t, e], [r, u]]; }, i.size = function(n) { return arguments.length ? (null == n ? t = e = r = u = null : (t = e = 0, r = +n[0], u = +n[1]), i) : null == t ? null : [r - t, u - e]; }, i);
    ...
    var xc = function() { return dt; }, bc = mo.map({ linear: xc, poly: Dr, quad: function() { return qr; }, cubic: function() { return zr; }, sin: function() { return jr; }, exp: function() { return Lr; }, circle: function() { return Hr; }, elastic: Fr, back: Pr, bounce: function() { return Or; } }), _c = mo.map({ "in": dt, out: Nr, "in-out": Tr, "out-in": function(n) { return Tr(Nr(n)); } });
    mo.ease = function(n) {
    ...
    }, Zr.prototype.toString = function() { return"translate(" + this.translate + ")rotate(" + this.rotate + ")skewX(" + this.skew + ")scale(" + this.scale + ")"; };
    ...
    mo.interpolateTransform = Br, mo.layout = {}, mo.layout.bundle = function() {
        ...
        function n() {
            ...
            for (o && v.sort(function(n, t) { return o(d[n], d[t]); }), a && m.forEach(function(n, t) { n.sort(function(n, e) { return a(u[t][n], u[t][e]); }); }), n = (Wo - s * i) / n, l = 0, h = -1; ++h < i;) {
                for (f = l, g = -1; ++g < i;) {
        ...
        function t(n) { n.px = mo.event.x, n.py = mo.event.y, a.resume(); }
        ...
        return a.tick = function() {
            ...
            if (u = [], "function" == typeof f)for (e = 0; d > e; ++e)u[e] = +f.call(this, m[e], e);
            else for (e = 0; d > e; ++e)u[e] = f;
            if (i = [], "function" == typeof h)for (e = 0; d > e; ++e)i[e] = +h.call(this, m[e], e);
            else for (e = 0; d > e; ++e)i[e] = h;
            if (o = [], "function" == typeof g)for (e = 0; p > e; ++e)o[e] = +g.call(this, v[e], e);
            else for (e = 0; p > e; ++e)o[e] = g;
            return a.resume();
        }, a.resume = function() { return a.alpha(.1); }, a.stop = function() { return a.alpha(0); }, a.drag = function() { return e || (e = mo.behavior.drag().origin(dt).on("dragstart.force", nu).on("drag.force", t).on("dragend.force", tu)), arguments.length ? (this.on("mouseover.force", eu).on("mouseout.force", ru).call(e), void 0) : e; }, mo.rebind(a, c, "on");
    };
    var Sc = 20, Ec = 1;
    mo.layout.hierarchy = function() {
        ...
        function t(n, r) {
            ...
            if (u && (a = u.length))for (var a, c = -1, l = r + 1; ++c < a;)o += t(u[c], l);
        ...
        var r = cu, u = ou, i = au;
        return e.sort = function(n) { return arguments.length ? (r = n, e) : r; }, e.children = function(n) { return arguments.length ? (u = n, e) : u; }, e.value = function(n) { return arguments.length ? (i = n, e) : i; }, e.revalue = function(n) { return t(n, 0), n; }, e;
        ...
        return e.size = function(n) { return arguments.length ? (u = n, e) : u; }, iu(e, r);
    }, mo.layout.pie = function() {
        function n(i) {
            var o = i.map(function(e, r) { return+t.call(n, e, r); }), a = +("function" == typeof r ? r.apply(this, arguments) : r), c = (("function" == typeof u ? u.apply(this, arguments) : u) - a) / mo.sum(o), l = mo.range(i.length);
            null != e && l.sort(e === kc ? function(n, t) { return o[t] - o[n]; } : function(n, t) { return e(i[n], i[t]); });
            var s = [];
        ...
        return n.value = function(e) { return arguments.length ? (t = e, n) : t; }, n.sort = function(t) { return arguments.length ? (e = t, n) : e; }, n.startAngle = function(t) { return arguments.length ? (r = t, n) : r; }, n.endAngle = function(t) { return arguments.length ? (u = t, n) : u; }, n;
    };
    var kc = {};
    mo.layout.stack = function() {
        function n(a, c) {
            var l = a.map(function(e, r) { return t.call(n, e, r); }), s = l.map(function(t) { return t.map(function(t, e) { return[i.call(n, t, e), o.call(n, t, e)]; }); }), f = e.call(n, s, c);
        ...
        return n.values = function(e) { return arguments.length ? (t = e, n) : t; }, n.order = function(t) { return arguments.length ? (e = "function" == typeof t ? t : Ac.get(t) || gu, n) : e; }, n.offset = function(t) { return arguments.length ? (r = "function" == typeof t ? t : Nc.get(t) || pu, n) : r; }, n.x = function(t) { return arguments.length ? (i = t, n) : i; }, n.y = function(t) { return arguments.length ? (o = t, n) : o; }, n.out = function(t) { return arguments.length ? (u = t, n) : u; }, n;
    };
    var Ac = mo.map({
            "inside-out": function(n) {
                var t, e, r = n.length, u = n.map(du), i = n.map(vu), o = mo.range(r).sort(function(n, t) { return u[n] - u[t]; }), a = 0, c = 0, l = [], s = [];
                for (t = 0; r > t; ++t)e = o[t], c > a ? (a += i[e], l.push(e)) : (c += i[e], s.push(e));
                return s.reverse().concat(l);
            },
            reverse: function(n) { return mo.range(n.length).reverse(); },
            "default": gu
        }),
        Nc = mo.map({
    ...
    mo.layout.histogram = function() {
        ...
        return n.value = function(t) { return arguments.length ? (e = t, n) : e; }, n.range = function(t) { return arguments.length ? (r = pt(t), n) : r; }, n.bins = function(t) { return arguments.length ? (u = "number" == typeof t ? function(n) { return Mu(n, t); } : pt(t), n) : u; }, n.frequency = function(e) { return arguments.length ? (t = !!e, n) : t; }, n;
        ...
        function n(n, i) {
            ...
            Nu(s, function(n, t) { n._tree = { ancestor: n, prelim: 0, mod: 0, change: 0, shift: 0, number: t ? t._tree.number + 1 : 0 }; }), o(s), a(s, -s._tree.prelim);
            var f = Su(s, ku), h = Su(s, Eu), g = Su(s, Au), p = f.x - e(f, h) / 2, d = h.x + e(h, f) / 2, v = g.depth || 1;
            return Nu(s, u ? function(n) { n.x *= r[0], n.y = n.depth * r[1], delete n._tree; } : function(n) { n.x = (n.x - p) / (d - p) * r[0], n.y = n.depth / v * r[1], delete n._tree; }), l;
        }

        var t = mo.layout.hierarchy().sort(null).value(null), e = bu, r = [1, 1], u = !1;
        return n.separation = function(t) { return arguments.length ? (e = t, n) : e; }, n.size = function(t) { return arguments.length ? (u = null == (r = t), n) : u ? null : r; }, n.nodeSize = function(t) { return arguments.length ? (u = null != (r = t), n) : u ? r : null; }, iu(n, t);
    }, mo.layout.pack = function() {
        function n(n, i) {
            var o = e.call(this, n, i), a = o[0], c = u[0], l = u[1], s = null == t ? Math.sqrt : "function" == typeof t ? t : function() { return t; };
            if (a.x = a.y = 0, Nu(a, function(n) { n.r = +s(n.value); }), Nu(a, Hu), r) {
                var f = r * (t ? 1 : Math.max(2 * a.r / c, 2 * a.r / l)) / 2;
                Nu(a, function(n) { n.r += f; }), Nu(a, Hu), Nu(a, function(n) { n.r -= f; });
            }
            return Ou(a, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / l)), o;
        }

        var t, e = mo.layout.hierarchy().sort(Cu), r = 0, u = [1, 1];
        return n.size = function(t) { return arguments.length ? (u = t, n) : u; }, n.radius = function(e) { return arguments.length ? (t = null == e || "function" == typeof e ? e : +e, n) : t; }, n.padding = function(t) { return arguments.length ? (r = +t, n) : r; }, iu(n, e);
        ...
        function n(n, i) {
            ...
            return Nu(c, u ? function(n) { n.x = (n.x - c.x) * r[0], n.y = (c.y - n.y) * r[1]; } : function(n) { n.x = (n.x - h) / (g - h) * r[0], n.y = (1 - (c.y ? n.y / c.y : 1)) * r[1]; }), a;
        }
        ...
        return i.size = function(n) { return arguments.length ? (l = n, i) : l; }, i.padding = function(n) {
            function t(t) {
                var e = n.call(i, t, t.depth);
                return null == e ? Vu(t) : Xu(t, "number" == typeof e ? [e, e, e, e] : e);
            }

            function e(t) { return Xu(t, n); }

            if (!arguments.length)return s;
            var r;
            return f = null == (s = n) ? Vu : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i;
        }, i.round = function(n) { return arguments.length ? (c = n ? Math.round : Number, i) : c != Number; }, i.sticky = function(n) { return arguments.length ? (h = n, o = null, i) : h; }, i.ratio = function(n) { return arguments.length ? (p = n, i) : p; }, i.mode = function(n) { return arguments.length ? (g = n + "", i) : g; }, iu(i, a);
    }, mo.random = {
        normal: function(n, t) {
    ...
    mo.scale.linear = function() { return Qu([0, 1], [0, 1], Er, !1); }, mo.scale.log = function() { return ii(mo.scale.linear().domain([0, 1]), 10, !0, [1, 10]); };
    var qc = mo.format(".0e"), zc = { floor: function(n) { return-Math.ceil(-n); }, ceil: function(n) { return-Math.floor(-n); } };
    mo.scale.pow = function() { return oi(mo.scale.linear(), 1, [0, 1]); }, mo.scale.sqrt = function() { return mo.scale.pow().exponent(.5); }, mo.scale.ordinal = function() { return ci([], { t: "range", a: [[]] }); }, mo.scale.category10 = function() { return mo.scale.ordinal().range(Cc); }, mo.scale.category20 = function() { return mo.scale.ordinal().range(Dc); }, mo.scale.category20b = function() { return mo.scale.ordinal().range(jc); }, mo.scale.category20c = function() { return mo.scale.ordinal().range(Lc); };
    ...
    mo.scale.quantile = function() { return li([], []); }, mo.scale.quantize = function() { return si(0, 1, [0, 1]); }, mo.scale.threshold = function() { return fi([.5], [0, 1]); }, mo.scale.identity = function() { return hi([0, 1]); }, mo.svg.arc = function() {
        function n() {
        ...
        return n.innerRadius = function(e) { return arguments.length ? (t = pt(e), n) : t; }, n.outerRadius = function(t) { return arguments.length ? (e = pt(t), n) : e; }, n.startAngle = function(t) { return arguments.length ? (r = pt(t), n) : r; }, n.endAngle = function(t) { return arguments.length ? (u = pt(t), n) : u; }, n.centroid = function() {
    ...
    mo.svg.line.radial = function() {
    ...
    }, We.reverse = Je, Je.reverse = We, mo.svg.area = function() { return yi(dt); }, mo.svg.area.radial = function() {
        var n = yi(mi);
        ...
        function r(n, t, e) { return"A" + n + "," + n + " 0 " + +(e > Bo) + ",1 " + t; }

        function u(n, t, e, r) { return"Q 0,0 " + r; }

        var i = De, o = je, a = Mi, c = di, l = vi;
        return n.radius = function(t) { return arguments.length ? (a = pt(t), n) : a; }, n.source = function(t) { return arguments.length ? (i = pt(t), n) : i; }, n.target = function(t) { return arguments.length ? (o = pt(t), n) : o; }, n.startAngle = function(t) { return arguments.length ? (c = pt(t), n) : c; }, n.endAngle = function(t) { return arguments.length ? (l = pt(t), n) : l; }, n;
        ...
        return n.projection = function(n) { return arguments.length ? e(bi(t = n)) : t; }, n;
    }, mo.svg.symbol = function() {
        function n(n, r) { return(Pc.get(t.call(this, n, r)) || Si)(e.call(this, n, r)); }
    ...
    Uc.call = Ro.call, Uc.empty = Ro.empty, Uc.node = Ro.node, Uc.size = Ro.size, mo.transition = function(n) { return arguments.length ? Oc ? n.transition() : n : Uo.transition(); }, mo.transition.prototype = Uc, Uc.select = function(n) {
        ...
        var e = this.id;
        return arguments.length < 2 ? this.node().__transition__[e].tween.get(n) : N(this, null == t ? function(t) { t.__transition__[e].tween.remove(n); } : function(r) { r.__transition__[e].tween.set(n, t); });
        ...
        function u(t) {
            return null == t ? r : (t += "", function() {
                ...
                return u !== t && (r = Er(u, t), function(t) { this.style.setProperty(n, r(t), e); });
            });
        }
        ...
        function r(r, u) {
            ...
            return i && function(t) { this.style.setProperty(n, i(t), e); };
        }

        return arguments.length < 3 && (e = ""), this.tween("style." + n, r);
    }, Uc.text = function(n) { return ki(this, "text", n, Ai); }, Uc.remove = function() {
        ...
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = mo.ease.apply(mo, arguments)), N(this, function(e) { e.__transition__[t].ease = n; }));
    }, Uc.delay = function(n) {
        var t = this.id;
        return N(this, "function" == typeof n ? function(e, r, u) { e.__transition__[t].delay = +n.call(e, e.__data__, r, u); } : (n = +n, function(e) { e.__transition__[t].delay = n; }));
    }, Uc.duration = function(n) {
        var t = this.id;
        return N(this, "function" == typeof n ? function(e, r, u) { e.__transition__[t].duration = Math.max(1, n.call(e, e.__data__, r, u)); } : (n = Math.max(1, n), function(e) { e.__transition__[t].duration = n; }));
    }, Uc.each = function(n, t) {
        var e = this.id;
        if (arguments.length < 2) {
            var r = Rc, u = Oc;
            Oc = e, N(this, function(t, r, u) { Rc = t.__transition__[e], n.call(t, t.__data__, r, u); }), Rc = r, Oc = u;
        } else
            N(this, function(r) {
        ...
        function n(n) {
            n.each(function() {
                ...
                if (f.rangeBand) {
                    var k = f.rangeBand() / 2, A = function(n) { return f(n) + k; };
        ...
        return n.scale = function(t) { return arguments.length ? (e = t, n) : e; }, n.orient = function(t) { return arguments.length ? (r = t in Xc ? t + "" : Vc, n) : r; }, n.ticks = function() { return arguments.length ? (a = arguments, n) : a; }, n.tickValues = function(t) { return arguments.length ? (c = t, n) : c; }, n.tickFormat = function(e) { return arguments.length ? (t = e, n) : t; }, n.tickSize = function(t) {
            var e = arguments.length;
            return e ? (u = +t, i = +arguments[e - 1], n) : u;
        }, n.innerTickSize = function(t) { return arguments.length ? (u = +t, n) : u; }, n.outerTickSize = function(t) { return arguments.length ? (i = +t, n) : i; }, n.tickPadding = function(t) { return arguments.length ? (o = +t, n) : o; }, n.tickSubdivide = function() { return arguments.length && n; }, n;
    };
    ...
    mo.svg.brush = function() {
        function n(i) {
            i.each(function() {
                ...
                a.exit().remove(), a.enter().append("g").attr("class", function(n) { return"resize " + n; }).style("cursor", function(n) { return $c[n]; }).append("rect").attr("x", function(n) { return/[ew]$/.test(n) ? -3 : null; }).attr("y", function(n) { return/^[ns]/.test(n) ? -3 : null; }).attr("width", 6).attr("height", 6).style("visibility", "hidden"), a.style("display", n.empty() ? "none" : null);
        ...
        function t(n) { n.selectAll(".resize").attr("transform", function(n) { return"translate(" + s[+/e$/.test(n)] + "," + h[+/^s/.test(n)] + ")"; }); }

        function e(n) { n.select(".extent").attr("x", s[0]), n.selectAll(".extent,.n>rect,.s>rect").attr("width", s[1] - s[0]); }

        function r(n) { n.select(".extent").attr("y", h[0]), n.selectAll(".extent,.e>rect,.w>rect").attr("height", h[1] - h[0]); }

        function u() {
            function u() { 32 == mo.event.keyCode && (N || (M = null, q[0] -= s[1], q[1] -= h[1], N = 2), f()); }

            function g() { 32 == mo.event.keyCode && 2 == N && (q[0] += s[1], q[1] += h[1], N = 0, f()); }
            ...
            function y() { v(), S.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), mo.select("body").style("cursor", null), z.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), T(), w({ type: "brushend" }); }
        ...
        return n.event = function(n) {
            n.each(function() {
                ...
                this.__chart__ = t, Oc ? mo.select(this).transition().each("start.brush", function() { i = e.i, o = e.j, s = e.x, h = e.y, n({ type: "brushstart" }); }).tween("brush:brush", function() {
                    var e = kr(s, t.x), r = kr(h, t.y);
                    return i = o = null, function(u) { s = t.x = e(u), h = t.y = r(u), n({ type: "brush", mode: "resize" }); };
                }).each("end.brush", function() { i = t.i, o = t.j, n({ type: "brush", mode: "resize" }), n({ type: "brushend" }); }) : (n({ type: "brushstart" }), n({ type: "brush", mode: "resize" }), n({ type: "brushend" }));
            });
        }, n.x = function(t) { return arguments.length ? (c = t, v = Bc[!c << 1 | !l], n) : c; }, n.y = function(t) { return arguments.length ? (l = t, v = Bc[!c << 1 | !l], n) : l; }, n.clamp = function(t) { return arguments.length ? (c && l ? (p = !!t[0], d = !!t[1]) : c ? p = !!t : l && (d = !!t), n) : c && l ? [p, d] : c ? p : l ? d : null; }, n.extent = function(t) {
            var e, r, u, a, f;
            return arguments.length ? (c && (e = t[0], r = t[1], l && (e = e[0], r = r[0]), i = [e, r], c.invert && (e = c(e), r = c(r)), e > r && (f = e, e = r, r = f), (e != s[0] || r != s[1]) && (s = [e, r])), l && (u = t[0], a = t[1], c && (u = u[1], a = a[1]), o = [u, a], l.invert && (u = l(u), a = l(a)), u > a && (f = u, u = a, a = f), (u != h[0] || a != h[1]) && (h = [u, a])), n) : (c && (i ? (e = i[0], r = i[1]) : (e = s[0], r = s[1], c.invert && (e = c.invert(e), r = c.invert(r)), e > r && (f = e, e = r, r = f))), l && (o ? (u = o[0], a = o[1]) : (u = h[0], a = h[1], l.invert && (u = l.invert(u), a = l.invert(a)), u > a && (f = u, u = a, a = f))), c && l ? [[e, u], [r, a]] : c ? [e, r] : l && [u, a]);
        }, n.clear = function() { return n.empty() || (s = [0, 0], h = [0, 0], i = o = null), n; }, n.empty = function() { return!!c && s[0] == s[1] || !!l && h[0] == h[1]; }, mo.rebind(n, a, "on");
    };
    var $c = { n: "ns-resize", e: "ew-resize", s: "ns-resize", w: "ew-resize", nw: "nwse-resize", ne: "nesw-resize", se: "nwse-resize", sw: "nesw-resize" }, Bc = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Wc = mo.time = {}, Jc = Date, Gc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    zi.prototype = { getDate: function() { return this._.getUTCDate(); }, getDay: function() { return this._.getUTCDay(); }, getFullYear: function() { return this._.getUTCFullYear(); }, getHours: function() { return this._.getUTCHours(); }, getMilliseconds: function() { return this._.getUTCMilliseconds(); }, getMinutes: function() { return this._.getUTCMinutes(); }, getMonth: function() { return this._.getUTCMonth(); }, getSeconds: function() { return this._.getUTCSeconds(); }, getTime: function() { return this._.getTime(); }, getTimezoneOffset: function() { return 0; }, valueOf: function() { return this._.valueOf(); }, setDate: function() { Kc.setUTCDate.apply(this._, arguments); }, setDay: function() { Kc.setUTCDay.apply(this._, arguments); }, setFullYear: function() { Kc.setUTCFullYear.apply(this._, arguments); }, setHours: function() { Kc.setUTCHours.apply(this._, arguments); }, setMilliseconds: function() { Kc.setUTCMilliseconds.apply(this._, arguments); }, setMinutes: function() { Kc.setUTCMinutes.apply(this._, arguments); }, setMonth: function() { Kc.setUTCMonth.apply(this._, arguments); }, setSeconds: function() { Kc.setUTCSeconds.apply(this._, arguments); }, setTime: function() { Kc.setTime.apply(this._, arguments); } };
    ...
    Wc.year = Ci(function(n) { return n = Wc.day(n), n.setMonth(0, 1), n; }, function(n, t) { n.setFullYear(n.getFullYear() + t); }, function(n) { return n.getFullYear(); }), Wc.years = Wc.year.range, Wc.years.utc = Wc.year.utc.range, Wc.day = Ci(function(n) {
        var t = new Jc(2e3, 0);
        return t.setFullYear(n.getFullYear(), n.getMonth(), n.getDate()), t;
    }, function(n, t) { n.setDate(n.getDate() + t); }, function(n) { return n.getDate() - 1; }), Wc.days = Wc.day.range, Wc.days.utc = Wc.day.utc.range, Wc.dayOfYear = function(n) {
        var t = Wc.year(n);
        return Math.floor((n - t - 6e4 * (n.getTimezoneOffset() - t.getTimezoneOffset())) / 864e5);
    }, Gc.forEach(function(n, t) {
        n = n.toLowerCase(), t = 7 - t;
        var e = Wc[n] = Ci(function(n) { return(n = Wc.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7), n; }, function(n, t) { n.setDate(n.getDate() + 7 * Math.floor(t)); }, function(n) {
